...
ny_noaa %>%
  ...
  layout(
    title = '<b> Snowfall by Minimum Temperature, 2000-2010 <b>', xaxis = list(title = 'Minimum Temperature (C)'), yaxis = list(title = 'Snowfall (mm)'), legend = list(title = list(text = 'Month')))
```
...
ny_noaa %>% 
  ...
  layout(
    title = '<b> Maximum Temperature by Year, 2000-2010 <b>', xaxis = list(title = 'Year'), yaxis = list(title = 'Maximum Temperature (C)'), legend = list(title = list(text = 'Year')))
```
...
ny_noaa %>% 
  ...
  layout(
    title = '<b> Average Preciptation by Month, 2000-2010 <b>', xaxis = list(title = 'Month'), yaxis = list(title = 'Average Precipitation (mm)'), legend = list(title = list(text = 'Month')))
```
